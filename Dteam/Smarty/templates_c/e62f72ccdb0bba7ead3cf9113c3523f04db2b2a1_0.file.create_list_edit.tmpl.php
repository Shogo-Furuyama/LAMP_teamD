<?php
/* Smarty version 4.1.1, created on 2023-08-06 23:09:22
  from '/home/j2023d/public_html/Smarty/templates/create_list_edit.tmpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_64cfa992b4bfa0_20150106',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e62f72ccdb0bba7ead3cf9113c3523f04db2b2a1' => 
    array (
      0 => '/home/j2023d/public_html/Smarty/templates/create_list_edit.tmpl',
      1 => 1691330953,
      2 => 'file',
    ),
  ),
...
function content_64cfa992b4bfa0_20150106 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ja">
...
&id=<?php echo $_smarty_tpl->tpl_vars['list']->value['list_id'];?>
...
echo $_smarty_tpl->tpl_vars['user_icon']->value;
                    ...
                    <input type="text" class="form-control" placeholder="このリストのタイトルを入力してください" name="title"
                        maxlength="50" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list']->value['list_title'], ENT_QUOTES, 'UTF-8', true);?>
">
...
?>
                    ...
                    <textarea class="form-control my-5" rows="6" style="resize: none;" placeholder="このリストの紹介文を入力してください"
                        name="comment" maxlength="200"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list']->value['list_comment'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
...
?>
                            <div id="regi_<?php echo $_smarty_tpl->tpl_vars['value']->value['index'];?>
">
                                <div class="reg_num"><?php echo $_smarty_tpl->tpl_vars['value']->value['index']+1;?>
</div>
                                <div class="book_img">
...
">
                                ...
                                <div class="book_info">
                                    ...
                                    <h5><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['value']->value['authors'], ENT_QUOTES, 'UTF-8', true);?>
</h5>
                                    <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['value']->value['book_id'];?>
">
                                </div>
                                <textarea class="form-control book_introduction" placeholder="この本の紹介文を入力してください"
                                    maxlength="200"><?php if ($_smarty_tpl->tpl_vars['value']->value['comment'] !== false) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['value']->value['comment']['comment'], ENT_QUOTES, 'UTF-8', true);
}?></textarea>
                                <div class="book_rep"><button type="button">▲</button><button type="button">▼</button>
                                </div><a href="javascript:void(0)" class="book_delete"><img src="./img/dBox.png"></a>
                            </div>
                        <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <input type="hidden" name="genre" value="<?php echo $_smarty_tpl->tpl_vars['list']->value['genre_id'];?>
">
            <input type="hidden" name="target" value="<?php echo $_smarty_tpl->tpl_vars['list']->value['target_id'];?>
">
...
>
            ...
            async function bookSearch(page) {
                ...
                jsonObj.books.forEach(book => {
                    new_search_div.appendChild(create_search_book(book.id, i, book.title, book.authors, book
                        .link));
                    ++i;
                });
            ...
            if (flag) {
                setPostData('genre', sGenre)
                setPostData('target', sTarget);
            ...
            document.addEventListener('DOMContentLoaded', function() {
                selectGenre(Number(document.querySelector('[name="genre"]').value));
                selectTarget(Number(document.querySelector('[name="target"]').value));
                for (let i = 0;; ++i) {
                    const node = document.getElementById('regi_' + i);
                    if (node == null) {
                        break;
                    }
                    const buttons = node.querySelectorAll('button');
                    buttons[0].addEventListener('click', regiReplace(i, true));
                    buttons[1].addEventListener('click', regiReplace(i, false));
                    node.querySelector('a').addEventListener('click', bookRegiDelete(i));
                    regiList.push(node.querySelector('input').value);
                    regiOrder.push(i);
                    ++regiCount;
                }
            });
